CREATE TABLE t_ciudad (
    ...
    CONSTRAINT pk_t_ciudad PRIMARY KEY (id)
);
...
CREATE TABLE t_seguromed (
    ...
    CONSTRAINT pk_t_seguromed PRIMARY KEY (id)
);
...
CREATE TABLE t_barrio (
    ...
    CONSTRAINT pk_t_barrio PRIMARY KEY (id)
);
...
CREATE TABLE t_medico (
    ...
    CONSTRAINT pk_t_medico PRIMARY KEY (id)
);
...
CREATE TABLE t_sala (
    ...
    CONSTRAINT pk_t_sala PRIMARY KEY (id)
);
...
CREATE TABLE t_cama (
    ...
    CONSTRAINT pk_t_cama PRIMARY KEY (id)
);
...
CREATE TABLE t_especializacion (
    ...
    CONSTRAINT pk_t_especializacion PRIMARY KEY (id)
);
...
CREATE TABLE t_habitacion (
    ...
    CONSTRAINT pk_t_habitacion PRIMARY KEY (id)
);
...
CREATE TABLE t_ingreso (
    ...
    CONSTRAINT pk_t_ingreso PRIMARY KEY (id)
);
CREATE TABLE t_valoracion (
    ...
    CONSTRAINT pk_t_valoracion PRIMARY KEY (id)
);
...
CREATE TABLE t_hospitalizacion (
    ...
    CONSTRAINT pk_t_hospitalizacion PRIMARY KEY (id)
);
...
CREATE TABLE t_paciente (
    ...
    CONSTRAINT pk_t_paciente PRIMARY KEY (cedula)
);
...
CREATE TABLE t_telefono (
    ...
    CONSTRAINT pk_t_telefono PRIMARY KEY (id)
);
...
CREATE TABLE t_tratamiento (
    ...
    CONSTRAINT pk_t_tratamiento PRIMARY KEY (id)
);
...
CREATE TABLE t_receta (
    ...
    CONSTRAINT pk_t_receta PRIMARY KEY (id)
);
